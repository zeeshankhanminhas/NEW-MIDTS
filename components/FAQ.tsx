...
export default function FAQ() {
  return (
    <section id="faq" className="section_faq border-y border-white/10 bg-[var(--black)] py-32 text-white md:py-44">
      <div className="container_large padding_global">
        <div className="faq_wrapper mx-auto max-w-4xl">
          <div className="faq_heading motion_fade_up mx-auto max-w-2xl text-center">
            <p className="text_eyebrow mb-8 text-sm font-semibold uppercase text-neutral-200">FAQ</p>
          ...
          <div className="grid_faq mt-16 border-y border-white/15">
            {faqs.map((item) => (
              <article key={item.question} className="card_faq motion_fade_up grid gap-4 border-b border-white/15 py-7 last:border-b-0 md:grid-cols-[0.75fr_1fr]">
