      ...
      <div className="container_large padding_global">
        <div className="cta_wrapper grid gap-10 rounded-lg border border-black/10 bg-[#0a2f2b] p-8 text-white shadow-xl shadow-black/10 md:grid-cols-[0.9fr_1.1fr] md:p-10">
          <div className="cta_content">
            ...
            <a className="button_secondary mt-8 inline-flex min-h-12 items-center justify-center rounded-md border border-white/20 px-6 py-3 text-sm font-medium uppercase text-white transition hover:border-white/50" href="mailto:hello@midts.co.uk?subject=MIDTS%20requirement">
              Email instead
            </a>
          </div>
          <EnquiryForm />
