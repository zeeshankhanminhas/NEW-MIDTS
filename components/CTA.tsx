      ...
      <div className="container_large padding_global">
        <div className="cta_wrapper motion_fade_up mx-auto grid max-w-5xl gap-12 border-y border-black/10 py-12 md:grid-cols-[0.85fr_1.15fr] md:items-start">
          <div className="cta_content">
            ...
            <a className="button_secondary motion_button mt-10 inline-flex min-h-12 items-center justify-center rounded-md border border-black/20 px-6 py-3 text-sm font-medium uppercase text-[var(--ink)] transition hover:border-black/50" href="mailto:intake@midts.com?subject=MIDTS%20initial%20request">
              Email instead
            </a>
          </div>
          <EnquiryForm />
