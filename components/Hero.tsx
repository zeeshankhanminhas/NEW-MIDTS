    ...
    <section id="top" className="section_hero motion_hero border-b border-white/10 bg-[var(--black)] py-36 md:py-52">
      <div className="container_large padding_global">
        <div className="hero_wrapper mx-auto max-w-2xl text-center">
          <p className="text_eyebrow mb-8 text-sm font-semibold uppercase text-neutral-200">
          ...
          <div className="hero_actions mt-14">
            <a className="button_primary motion_button inline-flex min-h-14 items-center justify-center rounded-md bg-white px-8 py-4 text-sm font-medium uppercase text-black transition hover:bg-white" href="#contact">
              Start your request
            </a>
            <p className="text_support mx-auto mt-6 max-w-xl text-sm text-neutral-300">
          ...
          <aside className="scope_wrapper mt-14 border-y border-white/10 py-5" aria-label="Engineering support capabilities">
            <div className="grid_capabilities grid gap-4 text-center text-xs font-medium uppercase text-neutral-300 md:grid-cols-3">
