      ...
      <div className="container_large padding_global">
        <div className="hero_wrapper mx-auto max-w-2xl text-center">
          ...
          <div className="hero_actions mt-14">
            <a className="button_primary motion_button inline-flex min-h-14 items-center justify-center rounded-md bg-[var(--paper)] px-8 py-4 text-sm font-medium uppercase text-black transition hover:bg-[var(--technical)]" href="#contact">
              Start your request
            </a>
