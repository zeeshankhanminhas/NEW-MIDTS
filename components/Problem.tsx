    ...
    <section className="section_problem border-t border-black/10 bg-[var(--paper)] py-32 text-[var(--ink)] md:py-44">
      <div className="container_large padding_global">
        <div className="problem_wrapper mx-auto max-w-2xl text-center">
          ...
          <div className="grid_signals mt-14 grid gap-4 border-y border-white/15 py-5 text-xs font-semibold uppercase text-neutral-200 sm:grid-cols-2 md:grid-cols-4">
            {signals.map((signal) => (
              <p key={signal} className="text_signal md:border-l md:border-white/15 md:first:border-l-0">
                {signal}
              </p>
            ))}
          </div>
