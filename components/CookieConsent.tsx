...
export default function CookieConsent() {
  ...
  return (
    <section
      className="cookie_banner fixed inset-x-0 bottom-0 z-50 border-t border-black/10 bg-white px-5 py-5 text-[var(--ink)] shadow-[0_-12px_40px_rgba(0,0,0,0.08)] sm:px-6 md:px-10"
