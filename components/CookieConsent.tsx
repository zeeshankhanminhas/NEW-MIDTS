...
export default function CookieConsent() {
  ...
  return (
    <section
      className="fixed inset-x-0 bottom-0 z-50 border-t border-black/10 bg-[#f7f7f5] px-5 py-5 text-[var(--ink)] shadow-[0_-12px_40px_rgba(0,0,0,0.08)] sm:px-6 md:px-10"
    ...
    >
      <div className="mx-auto grid max-w-7xl gap-4 md:grid-cols-[1fr_auto] md:items-center">
        ...
        <div className="grid gap-3 sm:grid-cols-2 md:min-w-[22rem]">
          <button
            className="min-h-11 rounded-md bg-[var(--ink)] px-5 py-3 text-sm font-medium uppercase text-white transition hover:bg-black"
            type="button"
          ...
          <button
            className="min-h-11 rounded-md border border-black/20 px-5 py-3 text-sm font-medium uppercase text-[var(--ink)] transition hover:border-black"
            type="button"
